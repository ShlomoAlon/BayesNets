...
class Variable:
    ...
    def add_domain_values(self, values: list):
        '''
...
class Factor:
    ...
    def get_value(self, variable_values) -> float:
        '''
    ...
    def add_value_at_current_assignment(self, number: float):
    ...
    def get_value_at_current_assignments(self) -> float:
        '''
...
class BN:
    ...
    Factors: List[Factor]
    def __init__(self, name, Vars: List[Variable], Factors: List[Factor]):
        self.name = name
    ...
    def get_variable(self, name) -> Optional[Variable]:
        '''
